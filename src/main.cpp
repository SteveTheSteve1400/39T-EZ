...
void initialize() {
  ...
  ez::as::auton_selector.add_autons({
    Auton("Close Auton", matchClose),
    Auton("Far Auton.", matchFar),
    Auton("Skills Auton. ", skillsFunc),
    Auton("Drive and Turn\n\nSlow down during drive.", wait_until_change_speed),
    Auton("Swing Example\n\nSwing, drive, swing.", swing_example),
    Auton("Combine all 3 movements", combining_movements),
    Auton("PIDTest.", interfered_example),
  });
 ...
 * the ield Management System or the VEX Competition Switch in the autonomous
...
void opcontrol() {
  ...
  while (true) {
    ...
    else if(controller.get_digital(pros::E_CONTROLLER_DIGITAL_Y) and signs == false){
			signs = true;
			pnC.set_value(signs);
			pros::delay(200);
		}
    ...
    // . . .
		...
		controller.print(0,0, "Speed = %d",jello);
